...
public class LightsTests {
    ...
    public void trianglesDirectional() {
        ...
        scene.addGeometries(
                new Triangle(Color.BLACK, new Material(0.8, 0.2, 300), new Point3D(-150, 150, 150), new Point3D(150, 150, 150), new Point3D(75, -75, 150)),
    ...
    public void trianglesSpot() {
        ...
        scene.addLights(new SpotLight(new Color(500, 0, 0),
                new Point3D(0, 0, -1), new Vector(0, -1, 0),
                1, 0.0001, 0.000005));
        scene.addLights(new SpotLight(new Color(500, 500, 500),
                new Point3D(100, 200,100 ), new Vector(-1, -1, 0),
                0.5, 0.0001, 0.000005));

        scene.addLights(new DirectionalLight(new Color(300, 150, 0), new Vector(0, 0, -1)));
        scene.addLights(new DirectionalLight(new Color(0, 0, 500), new Vector(10000, -10, -10000)));
    ...
    public void triangles2Lights() {
        ...
        scene.addLights(new SpotLight(new Color(500, 0, 0),
                new Point3D(0, 0, -1), new Vector(0, -1, 0),
                1, 0.0001, 0.000005));
        ImageWriter imageWriter = new ImageWriter("2Light", 200, 200, 500, 500);
        Render render = new Render(imageWriter, scene);
